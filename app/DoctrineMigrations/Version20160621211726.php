 ...
 */
class Version20160621211726 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE preview preview TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE preview preview TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
}
