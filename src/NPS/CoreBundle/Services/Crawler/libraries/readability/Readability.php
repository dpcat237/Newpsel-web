<?php
namespace NPS\CoreBundle\Services\Crawler\libraries\readability;
/** 
...
class Readability
{
	...
	*/	
	function __construct($html, $url=null, $parser='libxml')
	{
		...
		$this->dom->registerNodeClass('DOMElement', 'NPS\CoreBundle\Services\Crawler\libraries\readability\JSLikeHTMLElement');
	}
